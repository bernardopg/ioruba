...
5. closing the main window hides the app to the tray and `Sair` from the tray exits cleanly in the release binary
6. an AppImage generated by `tauri build -- --bundles appimage` opens correctly when built in a compatible Linux base
